          ...
          <div className="mt-4">
            ...
            >
              <span className="p-2">
                ...
                <FaChevronUp className={`text-sm transition-all duration-300 ease-out ${isExpensesOpen ? 'rotate-180' : ''}`} />
        ...
        {(role === "owner" || role === "operator") && (
          <div className="mt-4">
            ...
            >
              ...
              <FaChevronUp className={`text-sm transition-all duration-300 ease-out ${isBookingOpen ? 'rotate-180' : ''}`} />
            </h3>
